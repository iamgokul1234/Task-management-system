...
export default function EmployeeDashboard() {
  ...
  const statCards = [
    { title: 'My Active Tasks', value: stats?.activeTasks || 0, icon: Clock, color: 'text-blue-600', bgColor: 'bg-blue-100' },
    { title: 'My Pending Tasks', value: stats?.pendingTasks || 0, icon: AlertCircle, color: 'text-amber-600', bgColor: 'bg-amber-100' },
    { title: 'My Completed', value: stats?.completedTasks || 0, icon: CheckCircle, color: 'text-green-600', bgColor: 'bg-green-100' },
    { title: 'My Late Tasks', value: stats?.lateTasks || 0, icon: CheckSquare, color: 'text-red-600', bgColor: 'bg-red-100' },
  ];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">Overview of your assigned tasks and deadlines.</p>
      </div>
      ...
      <Card>
        <div className="px-4 py-4 sm:px-6 sm:py-5 border-b border-slate-200">
          <h3 className="text-base sm:text-lg font-medium leading-6 text-slate-900">Upcoming Deadlines</h3>
        </div>
